...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
      ...
      (setq org-agenda-file-project              (expand-file-name "./project/project.org" org-agenda-dir))
      (setq org-agenda-file-project-moze         (expand-file-name "./project/moze.org"    org-agenda-dir))
      ...
      (setq org-agenda-files                     (list org-agenda-dir (concat org-agenda-dir "/project")))
      ...
      (setq org-capture-templates
            '(
              ...
              ;; Templates for the PORJECT keyword sequence
              ("p"  "project")
              ("pp" "Project"         entry (file+headline org-agenda-file-project       "Project")
               "* TODO [#B] %?\n%i\n%U"       :empty-lines 1)
              ("pm" "Project-Moze"    entry (file+headline org-agenda-file-project-moze  "Moze")
               "* TODO [#B] %?\n%i\n%U"       :empty-lines 1)
